...
M7. New message workflow [~]
    ...
    7.6. Error/No-response from LLM processing, message history editing and deletion [ ]
M8. Full filtering language implementation [ ]
M9. Model stor/list management (api keys, model cw, tpm, rpm etc.) [ ]
M10. UX polish (message formatting (.md), performance, flickering, smoothing, transitions) and Help [ ]
- Release.
