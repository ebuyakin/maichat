...
## Key architectural contraints
- The app is now in production.
- All changes affecting current modules must be first carefully audited and vetted and it must not interfere with existing functionaliy.
